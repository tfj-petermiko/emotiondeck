...
export default function LearnArticleEmpathyThroughObservation() {
    ...
    async function loadData() {
      try {
        const res = await fetch(
          "/content/learn/articles/reading_faces/empathy_through_observation/index.json"
        );
  ...
  const handleBackClick = () => {
    setLoadingBack(true);
    setTimeout(() => {
      window.location.href = "/learn/articles/reading-faces";
    }, 600);
  };
