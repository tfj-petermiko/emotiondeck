...
export default function LearnArticleEmotionalAuthenticity() {
    ...
    async function loadData() {
      try {
        const res = await fetch(
          "/content/learn/articles/truth_and_emotion/emotional_authenticity/index.json"
        );
  ...
  const handleBackClick = () => {
    setLoadingBack(true);
    setTimeout(() => {
      window.location.href = "/learn/articles/truth-and-emotion";
    }, 600);
  };
