...
export default function TruthAndEmotionPage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const res = await fetch("/content/learn/articles/truth_and_emotion/index.json");
                  ...
                  <td className="learnpage-maincell">
                    ...
                    <div className="learnpage-buttonwrap">
                      <button
                        onClick={() =>
                          handleModuleClick(
                            `/learn/articles/truth-and-emotion/${article.slug}`,
                            article.slug
                          )
                        }
