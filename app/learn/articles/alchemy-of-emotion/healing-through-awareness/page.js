...
export default function LearnArticleTableSingle() {
    ...
    async function loadData() {
      try {
        const res = await fetch(
          "/content/learn/articles/alchemy_of_emotion/healing_through_awareness/index.json"
        );
  ...
  const handleBackClick = () => {
    setLoadingBack(true);
    setTimeout(() => (window.location.href = "/learn/articles/alchemy-of-emotion"), 600);
  };
            ...
            <tbody>
              <tr className="learn-module-row">
                <td className="learn-module-cell-main">
                  <p className="font-semibold mb-4 italic text-gray-300">
