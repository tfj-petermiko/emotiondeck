...
export default function AlchemyOfEmotionPage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const res = await fetch("/content/learn/articles/alchemy_of_emotion/index.json");
                  ...
                  <td className="learnpage-maincell">
                    ...
                    <div className="learnpage-buttonwrap">
                      <button
                        onClick={() =>
                          handleModuleClick(
                            `/learn/articles/alchemy-of-emotion/${article.slug}`,
                            article.slug
                          )
                        }
