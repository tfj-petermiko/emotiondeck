...
export default function LearnArticlePathToIntegration() {
    ...
    async function loadData() {
      try {
        const res = await fetch(
          "/content/learn/articles/individuation_and_wholeness/path_to_integration/index.json"
        );
  ...
  const handleBackClick = () => {
    setLoadingBack(true);
    setTimeout(() => {
      window.location.href = "/learn/articles/individuation-and-wholeness";
    }, 600);
  };
