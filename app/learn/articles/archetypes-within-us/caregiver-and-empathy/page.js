...
export default function LearnArticleCaregiverEmpathy() {
    ...
    async function loadData() {
      try {
        const res = await fetch(
          "/content/learn/articles/archetypes_within_us/caregiver_and_empathy/index.json"
        );
  ...
  const handleBackClick = () => {
    setLoadingBack(true);
    setTimeout(() => {
      window.location.href = "/learn/articles/archetypes-within-us";
    }, 600);
  };
