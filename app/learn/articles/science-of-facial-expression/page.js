...
export default function ScienceOfFacialExpressionPage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const res = await fetch("/content/learn/articles/science_of_facial_expression/index.json");
                  ...
                  <td className="learnpage-maincell">
                    ...
                    <div className="learnpage-buttonwrap">
                      <button
                        onClick={() =>
                          handleModuleClick(
                            `/learn/articles/science-of-facial-expression/${article.slug}`,
                            article.slug
                          )
                        }
