...
export default function LearnArticleMicroexpressionsAndTruth() {
    ...
    async function loadData() {
      try {
        const res = await fetch(
          "/content/learn/articles/science_of_facial_expression/microexpressions_and_truth/index.json"
        );
  ...
  const handleBackClick = () => {
    ...
    setTimeout(() => {
      window.location.href =
        "/learn/articles/science-of-facial-expression";
    }, 600);
  };
