...
export default function EmotionalSelfInDreamsPage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const res = await fetch("/content/learn/articles/emotional_self_in_dreams/index.json");
                  ...
                  <td className="learnpage-maincell">
                    ...
                    <div className="learnpage-buttonwrap">
                      <button
                        onClick={() =>
                          handleModuleClick(
                            `/learn/articles/emotional-self-in-dreams/${article.slug}`,
                            article.slug
                          )
                        }
