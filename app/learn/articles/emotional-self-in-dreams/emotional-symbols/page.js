...
export default function LearnArticleEmotionalSymbols() {
    ...
    async function loadData() {
      try {
        const res = await fetch(
          "/content/learn/articles/emotional_self_in_dreams/emotional_symbols/index.json"
        );
  ...
  const handleBackClick = () => {
    setLoadingBack(true);
    setTimeout(() => {
      window.location.href = "/learn/articles/emotional-self-in-dreams";
    }, 600);
  };
