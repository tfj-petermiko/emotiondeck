...
export default function LearnArticleScienceCompassion() {
    ...
    async function loadData() {
      try {
        const res = await fetch(
          "/content/learn/articles/empathy_psyche_and_science/science_of_compassion/index.json"
        );
  ...
  const handleBackClick = () => {
    setLoadingBack(true);
    setTimeout(() => {
      window.location.href = "/learn/articles/empathy-psyche-and-science";
    }, 600);
  };
