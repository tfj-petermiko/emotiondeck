...
export default function EmpathyPsycheAndSciencePage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const res = await fetch("/content/learn/articles/empathy_psyche_and_science/index.json");
                  ...
                  <td className="learnpage-maincell">
                    ...
                    <div className="learnpage-buttonwrap">
                      <button
                        onClick={() =>
                          handleModuleClick(
                            `/learn/articles/empathy-psyche-and-science/${article.slug}`,
                            article.slug
                          )
                        }
