...
export default function ShadowAndIntegrationPage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const res = await fetch("/content/learn/articles/shadow_and_integration/index.json");
                  ...
                  <td className="learnpage-maincell">
                    ...
                    <div className="learnpage-buttonwrap">
                      <button
                        onClick={() =>
                          handleModuleClick(
                            `/learn/articles/shadow-and-integration/${article.slug}`,
                            article.slug
                          )
                        }
