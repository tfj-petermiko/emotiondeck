...
export default function LearnArticleEmotionalTransformation() {
    ...
    async function loadData() {
      try {
        const res = await fetch(
          "/content/learn/articles/shadow_and_integration/emotional_transformation/index.json"
        );
  ...
  const handleBackClick = () => {
    setLoadingBack(true);
    setTimeout(() => {
      window.location.href = "/learn/articles/shadow-and-integration";
    }, 600);
  };
