...
export default function LearnArticleSharedLanguageOfFeeling() {
    ...
    async function loadData() {
      try {
        const res = await fetch(
          "/content/learn/articles/universal_emotions/shared_language_of_feeling/index.json"
        );
  ...
  const handleBackClick = () => {
    setLoadingBack(true);
    setTimeout(() => {
      window.location.href = "/learn/articles/universal-emotions";
    }, 600);
  };
